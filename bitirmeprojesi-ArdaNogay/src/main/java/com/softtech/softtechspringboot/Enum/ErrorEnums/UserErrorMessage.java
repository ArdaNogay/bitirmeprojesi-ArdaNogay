...
public enum UserErrorMessage implements BaseErrorMessage{
    USER_NOT_FOUND_USERNAME("Entities Could Not Found", "There are not any saved user with this username.", "bitirme3-100-404"),
    ...
    HAS_BLANK_USERNAME_PARAMETER("Encounter a Blank Parameter", "Username parameter can not be blank", "bitirme3-203-400"),;
